    ...
    >
      ...
      <div className="z-10 w-full flex-1 flex flex-col justify-between">
        ...
        <div>
          ...
          <AnimatePresence>
            {showAdd && (
              <motion.form
                ...
                onSubmit={handleAdd}
                className="mb-5 flex gap-2 overflow-hidden bg-white/20 p-3 rounded-xl border border-white/30 backdrop-blur-sm"
              >
                <input
                  type="text"
          ...
          {/* Day headers */}
          <div className="flex items-center mb-3.5 border-b border-zen-200/30 pb-2.5">
            <div className="flex-1" />
            <div className="flex gap-2">
              {last7Days.map(day => (
                <div
                  key={day.date}
                  className={`w-[30px] text-center flex flex-col items-center justify-center ${
                    day.isToday ? 'text-accent' : 'text-zen-450'
                  }`}
                >
                ...
                {habits.map((habit) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0 pr-3">
                      <p className="text-sm font-semibold text-zen-800 truncate font-sans tracking-wide">
                        {habit.name}
                      </p>
                      {habit.currentStreak > 0 && (
                        ...
                        >
                          ...
                          >
                            <HiOutlineFire className="w-3.5 h-3.5 text-[#c9a84c] drop-shadow-[0_1px_3px_rgba(201,168,76,0.3)]" />
                          </motion.span>
                          <span className="text-[10px] text-accent-gold font-bold font-sans tracking-wide">
                      ...
                      {last7Days.map(day => {
                        ...
                        return (
                          <button
                            ...
                            className={`shoji-checkbox ${isCompleted ? 'checked' : ''} !w-[30px] !h-[30px]`}
